...
import com.jobportal.user.security.JwtAuthenticationFilter;

import com.jobportal.user.service.CustomUserDetailsService;
...
import com.jobportal.user.security.DebugSecurityFilter;
...
public class SecurityBeansConfig {
    ...
    public SecurityBeansConfig(
            ...
            DebugSecurityFilter debugSecurityFilter
    ) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .addFilterAfter(debugSecurityFilter, JwtAuthenticationFilter.class);
